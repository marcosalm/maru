app.core.api = function() {
	...
	var handleError = function(request, textStatus, error) {
		...
		app.core.log.warning('Nenhum controller de erro da API especificada.', 'Maru/API');
		app.core.log.error('API respondeu com status ' + request.status, 'Maru/API');
	};
	...
	this.get = function(endpoint, headers, callback, errorHandler) {
		...
		app.core.log.debug('Chamando API endpoint [GET ' + endpoint + ']', 'Maru/API');
	...
	this.post = function(endpoint, data, headers, ajaxOptions, callback, errorHandler) {
		...
		var mergedHeaders = _mergeObject(getHeaders(), headers);
		app.core.log.debug('Chamando API endpoint [POST ' + endpoint + ']', 'Maru/API');
	...
	this.delete = function(endpoint, data, headers, callback, errorHandler) {
		...
		app.core.log.debug('Chamando API endpoint [DELETE ' + endpoint + ']', 'Maru/API');
